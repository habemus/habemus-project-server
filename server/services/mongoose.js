...
module.exports = function (app, options) {
  ...
  .then(() => {
    ...
    mongooseService.models.Project =
      require('../models/project')(conn, app, options);
    mongooseService.models.ProjectVersion =
      require('../models/project-version')(conn, app, options);
